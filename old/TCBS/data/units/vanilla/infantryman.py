...
class SandboxInfantryman(pygame.sprite.Sprite):
    """
    This is the version of your soldier that would be loaded in sandbox mode.
    """
    name = "Infantryman - $55"  # What to display at the top when this unit is selected.
...
class MultiplayerInfantryman(pygame.sprite.Sprite):
    """
...
MultiplayerInfantryman.__name__ = "vanilla_infantryman"
