...
private:
    ...
    void createInstance() {
        ...
        if (result != VK_SUCCESS) {
            std::string x = "failed to create instance! Result was ";
            x += std::to_string((int) result);
    ...
    void createSurface() {
        ...
        if (res != VK_SUCCESS) {
            throw std::runtime_error("failed to create window surface! Res = " + std::to_string(res));
        }
    }
...
int main() {
    ...
    hp::profiler_session::default_session = new hp::profiler_session("Default Session", "profiler_output.json");
#endif
...
#ifdef HP_PROFILING_ENABLED
    delete hp::profiler_session::default_session;
#endif
    return EXIT_SUCCESS;
}
