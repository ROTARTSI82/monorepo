...
const recognizedStaticCmds = new Set(["$q", "$b", "skip", "skip all", "buzz", "pause", "resume", "$info bonus", "$info tossup"]);
...
function exec(msg, room) {
    ...
    switch (msg.content) {
        ...
        case ("$scat ls"):
            msg.reply(`\`\`\`\n${arrToStr(room.settings.qFilterScat)}\n\`\`\``);
            break;

        case ("$scat la"):
            msg.reply(`\`\`\`\n${arrToStr(allowedScats)}\n\`\`\``);
            break;
        ...
        case ("$cat ls"):
            msg.reply(`\`\`\`\n${arrToStr(room.settings.qFilterCat)}\n\`\`\``);
            break;

        case ("$cat la"):
            msg.reply(`\`\`\`\n${arrToStr(allowedCats)}\n\`\`\``);
            break;
        ...
        case ("$tourn ls"):
            msg.reply(`\`\`\`\n${arrToStr(room.settings.qFilterTourn)}\n\`\`\``);
            break;
