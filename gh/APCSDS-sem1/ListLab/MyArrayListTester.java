...
public class MyArrayListTester
{
    ...
    {
        MyArrayList<Integer> your = new MyArrayList<>();
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            if (your.size() != real.size())
                throw new RuntimeException("Size is " + your.size() + " and should be "
                        + real.size());

            for (int index = 0; index < real.size(); index++)
                if (!Objects.equals(your.get(index), real.get(index)))
