...
public class TextBox {
    ...
    public void draw(Graphics2D graphics2D) {
        ...
        if (this.width == -1) {
            ...
            n2 = 0;
            n = 0;
            while (((Iterator<TextLine>) object3).hasNext()) { // modified
                object2 = ((Iterator<TextLine>) object3).next(); // modified
        ...
        int n4 = this.top;
        while (((Iterator<TextLine>) object2).hasNext()) { // modified
            object = (TextLine)((Iterator<TextLine>) object2).next();
