...
class CUP$parser$actions {
    ...
    public final Symbol CUP$parser$do_action(int i, lr_parser lr_parser, Stack stack, int i2) throws Exception {
        System.out.println("Sketchy function called");
        Object obj = null;
        switch (i) {
            case 0:
            ...
            case sym.BOOLEAN:
                ...
                return new Symbol(3, ((Symbol) stack.elementAt(i2 - 3)).left, ((Symbol) stack.elementAt(i2 + 0)).right, new Method(0, (String) ((Symbol) stack.elementAt(i2 - 2)).value, (List) ((Symbol) stack.elementAt(i2 - 1)).value, (Block) ((Symbol) stack.elementAt(i2 + 0)).value));
            case 38:
                ...
                return new Symbol(3, ((Symbol) stack.elementAt(i2 - 3)).left, ((Symbol) stack.elementAt(i2 + 0)).right, new Method(1, (String) ((Symbol) stack.elementAt(i2 - 2)).value, (List) ((Symbol) stack.elementAt(i2 - 1)).value, (Block) ((Symbol) stack.elementAt(i2 + 0)).value));
            case 39:
            ...
            case 48:
                ...
                list4.add(new C0000If((Expression) ((Symbol) stack.elementAt(i2 - 2)).value, (Statement) ((Symbol) stack.elementAt(i2 + 0)).value, null)); // sketchy
            ...
            case 49:
                ...
                arrayList4.add(new C0000If((Expression) ((Symbol) stack.elementAt(i2 - 2)).value, (Statement) ((Symbol) stack.elementAt(i2 + 0)).value, null)); // sketchy
            ...
            case 50:
                ...
                list5.add(new C0000If((Expression) ((Symbol) stack.elementAt(i2 - 4)).value, (Statement) ((Symbol) stack.elementAt(i2 - 2)).value, (Statement) ((Symbol) stack.elementAt(i2 + 0)).value));
            ...
            case 51:
                ...
                arrayList5.add(new C0000If((Expression) ((Symbol) stack.elementAt(i2 - 4)).value, (Statement) ((Symbol) stack.elementAt(i2 - 2)).value, (Statement) ((Symbol) stack.elementAt(i2 + 0)).value));
