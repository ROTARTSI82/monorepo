...
{
    public static BoxedValue NULL = box(null);
    ...
    public Object get()
    {
        if (value instanceof BoxedValue)
            throw new RuntimeException("nested boxed value (on get): " + this);
        return value;
    }
    ...
    {
        if (value instanceof BoxedValue)
            throw new RuntimeException("nested boxed value (on set): " + this);
        value = v;
        return this;
    }
